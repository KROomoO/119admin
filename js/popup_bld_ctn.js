$(document).on("click", "#sample_bld_btn", () => {
    blur_popUp_toggle();
    $("#popUp_container").load("../admin/popup_bld.html #popUp_bld_detail");
    $("#detail_content_container").load("../admin/popup_bld.html #popUp_bld1");
...
$(document).on("click", "#bld_history_btn", () => {
    $("#detail_content_container").load("../admin/popup_bld.html #popUp_bld2");
    $("#bld_photo").hide();
